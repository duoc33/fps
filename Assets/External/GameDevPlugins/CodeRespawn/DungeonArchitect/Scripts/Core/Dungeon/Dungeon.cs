...
namespace DungeonArchitect
{
    ...
    public class Dungeon : MonoBehaviour
    {
        ...
        public void BuildModifyByCC(List<DungeonThemeData> dungeonThemeDatas, bool Navigation = true)
        {
            IsCompleted = false;
            BuildModifyByCC(new RuntimeDungeonSceneObjectInstantiator(), dungeonThemeDatas);
            if (Navigation)
            {
        ...
        public void BuildModifyByCC(RuntimeDungeonSceneObjectInstantiator objectInstantiator, List<DungeonThemeData> dungeonThemeDatas)
        {
            ...
            if (dungeonBuilder.IsThemingSupported())
            {
                ...
                List<DungeonThemeData> themes = dungeonThemeDatas;
