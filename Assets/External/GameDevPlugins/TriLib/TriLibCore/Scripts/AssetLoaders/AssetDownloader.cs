...
namespace TriLibCore
{
    ...
    public class AssetDownloader
    {
        ...
        // /// Change By CC
        // /// </summary>
        // /// <param name="assetDownloader"></param>
        // /// <param name="unityWebRequest"></param>
        // /// <param name="onLoad"></param>
        // /// <param name="onMaterialsLoad"></param>
        // /// <param name="onProgress"></param>
        // /// <param name="onError"></param>
        // /// <param name="wrapperGameObject"></param>
        // /// <param name="assetLoaderOptions"></param>
        // /// <param name="customContextData"></param>
        // /// <param name="fileExtension"></param>
        // /// <param name="isZipFile"></param>
        // /// <param name="haltTask"></param>
        // /// <returns></returns>
        // public static Coroutine LoadModelFromUri(AssetDownloaderBehaviour assetDownloader,UnityWebRequest unityWebRequest, Action<AssetLoaderContext> onLoad, Action<AssetLoaderContext> onMaterialsLoad, Action<AssetLoaderContext, float> onProgress, Action<IContextualizedError> onError = null, GameObject wrapperGameObject = null, AssetLoaderOptions assetLoaderOptions = null, object customContextData = null, string fileExtension = null, bool? isZipFile = null, bool haltTask = false)
        // {
        //     return assetDownloader.StartCoroutine(assetDownloader.DownloadAsset(unityWebRequest, onLoad, onMaterialsLoad, onProgress, wrapperGameObject, onError, assetLoaderOptions, customContextData, fileExtension, isZipFile));
        // }
    }
