...
namespace KevinCastejon.HierarchicalFiniteStateMachineDemos.TechnicalDemo
{
    public class MainStateMachine : AbstractHierarchicalFiniteStateMachine
    {
        ...
        {
            Debug.Log(subStateMachine.GetType().Equals(typeof(BStateMachine)));

            Debug.Log(subStateMachine.GetStateMachine<AbstractHierarchicalFiniteStateMachine>().GetType().Equals(typeof(MainStateMachine))); 
